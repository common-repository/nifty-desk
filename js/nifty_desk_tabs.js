jQuery("document").ready(function()
	{
		...
		jQuery('#nifty_desk_settings').on('submit',function()
		{
    	...
    	jQuery('input[name="rb_nifty_desk_mailing_system_selection"]').unbind('click').on('click',function()
    	{
    			php_mailer_settings_outgoing_mail.determine();
    	});
...
var php_mailer_settings_outgoing_mail={
		determine:function()
		{
			var checked_radio=jQuery('input[name="rb_nifty_desk_mailing_system_selection"]').filter(':checked').attr('id');
			if(checked_radio==='rb_nifty_desk_mailing_system_selection_smtp')
			{
				this.show();
			}
			else
		...
		show:function()
		{
			jQuery('#nifty_desk_hidden_php_mailer_smtp_settings').show();
		},
		hide:function()
		{
			jQuery('#nifty_desk_hidden_php_mailer_smtp_settings').hide();
		}
};
